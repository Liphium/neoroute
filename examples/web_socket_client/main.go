...
func main() {
	...
	// Use the connector generated by neogen (hint: use go generate ./... to generate this, explanation in client.go)
	c := definitions.NewMainConnector(client.Config{
