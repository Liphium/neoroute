...
This example needs the [chat server example](https://github.com/Liphium/neoroute/tree/main/examples/chat_server) to be running in order to work. It shows you how you can connect to the server using the WebSocket transporter from the Go client SDK.
