...
require (
	...
	github.com/Liphium/neoroute/client v0.0.0 // indirect
	github.com/Liphium/neoroute/client/transporter/http v0.0.0 // indirect
	github.com/Liphium/neoroute/client/transporter/websocket v0.0.0 // indirect
