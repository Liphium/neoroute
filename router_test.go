...
func TestNeoRouter_getNeos(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			setup: func() (Router[any], []*NeoRouter[any]) {
				router := NewRouter[any](Config[any]{})
		...
		},
		{
			...
			setup: func() (Router[any], []*NeoRouter[any]) {
				router := NewRouter[any](Config[any]{})
				router2 := NewRouter[any](Config[any]{})
				router3 := NewRouter[any](Config[any]{})
		...
		},
		{
			...
			setup: func() (Router[any], []*NeoRouter[any]) {
				...
				router4 := NewRouter[any](Config[any]{})
				router5 := NewRouter[any](Config[any]{})
				router6 := NewRouter[any](Config[any]{})
				router4.AddRouters(router5, router6)

				router7 := NewRouter[any](Config[any]{})
				router8 := NewRouter[any](Config[any]{})
				router9 := NewRouter[any](Config[any]{})
